...
class OrderStatusWidget extends StatelessWidget {
  ...
  int get currentStatus =>
      allStatus[status]!; //! indica que o valor status nunca será nulo
...
class _StatusDot extends StatelessWidget {
  final bool isActive;
  final String title;
  final Color? backgroundColor; //pode ser nulo
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isActive
                ...
                : Colors.transparent, //Aqui muda a cor da bola
          ),
          child: isActive
              ? const Icon(
                  Icons.check,
              ...
              : const SizedBox.shrink(), //ou aparece o icone ou nada aparece
        ),
        const SizedBox(
          width: 5,
        ),
